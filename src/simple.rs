...
impl Swapchain {
    ...
    pub fn recreate(
        ...
        unsafe {
            ...
            self.render_pass = std::ptr::null_mut();
            ...
            // Now create a new swapchain with the new dimensions
            *self = Swapchain::new(context, surface_khr, width, height)?;
